...
import os
import openai
from fastapi import FastAPI, BackgroundTasks, APIRouter, UploadFile, File
...
@cache(expire=60)
async def tiny_dick(prompt: str, background_tasks: BackgroundTasks, photo: UploadFile = File(...), mask: UploadFile = File(...)):
    def mega_dick():
